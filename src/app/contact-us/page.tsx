      ...
      <MaxWidthWrapper className='py-8 px-6'>
        ...
        <section className='mt-12  '>
          <div className=''>
            ...
            <p className='text-justify pr-36 mt-3 text-lg text-zinc-700 tracking-tight'>
              We will respond back to you as soon as possible.
            </p>
          </div>

          <div className='flex justify-between  mt-8'>
            <div className='flex-[0.5] shadow-md border rounded-xl py-6 flex justify-start items-center'>
              <iframe
              ...
              <div className='border shadow-sm max-w-[30rem] flex justify-between items-center w-full p-8 rounded-2xl'>
                <div>
                  <p className='flex flex-col gap-y-0.5'>
                    ...
                    <span className='text-xl'>xxx@email.com</span>
                  </p>
                  <p className='flex flex-col mt-8 gap-y-0.5'>
                    <span className='text-zinc-600'>Phone</span>
                    <span className='text-xl'>+1934488484</span>
                  </p>
                </div>
